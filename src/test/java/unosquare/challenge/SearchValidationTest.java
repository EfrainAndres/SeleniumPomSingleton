...
public class SearchValidationTest extends BaseTest {
    ...
    public void searchValidationTest() throws IOException, ParseException {
        ...
        WindowsPage windowsPage = WindowsPage.getWindowsPage();
        SearchPage searchPage = SearchPage.getSearchPage();
        GamesPage gamesPage = GamesPage.getGamesPage();
        ...
        // 6. Count the elements on the first 3 pages and print the sum of elements and
        // all the titles
        ...
        // the price for later comparison
        ...
        // 9. Click on the "3 dot" button next to "Comprar" button and add the item to
        // the CART
        gamesPage.addToCart();

        // 10. In this page, you will see the price again, compare first price vs
        // current prince and they should match
        gamesPage.assertValues();
        // 11. Verify the app takes you to the Shopping Cart page and verify you have
        // one element available
        shoppingCartPage.assertItemAccount();

        // 12. Delete the item and verify you have 0 elements: "Tu carro está vacío"
